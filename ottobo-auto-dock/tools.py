...
def get_inverse_matrix(matrix):
    """
    Takes an matrix as numpy.arr, returns the inverse of that matrix

    PARAMS:
    >>>matrix: numpy.arr\n
    \n
    RETURNS:
    >>>t.inverse_matrix(matrix): numpy.arr
    """
    #utilizing transformation.py from tf class 
    return t.inverse_matrix(matrix)
